    ...
    if(input$zeroRem=='Yes'){
      ...
      output$tableID<-renderDataTable({
        ...
        tab=N_bear_tibble3() %>%
          ...
          select("�r","Medelvärde antal honor", "Undre konfidensintervall",
      ...
      output$tableID <- renderDataTable({
        ...
        tab <- N_bear_tibble3() %>%
          ...
          select("�r", "Medelvärde antal honor", "Undre konfidensintervall", "�vre konfidensintervall")
        datatable(tab,
                  caption = paste0(
