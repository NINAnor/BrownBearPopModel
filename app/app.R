...
ui <- navbarPage("Beskattningsmodell för honbjörnar V03.2025",
  id = "tabs",
  tabPanel(
    "Hem",
    ...
    fluidRow(column(8,
      ...
      conditionalPanel(
        ...
        wellPanel(tabsetPanel(
          tabPanel(
            title = "Data", htmlOutput("uploaded_attributes"),
            tableOutput("data_summary")
          ),
          tabPanel(
            title = "Uppladdad datatabell", htmlOutput("uploaded_summary"),
            tableOutput("view")
          )
        )),
        br(), br(),
    ...
    if (input$zeroRem == "Yes") {
      ...
      output$tableID <- renderDataTable({
        ...
        tab <- N_bear_tibble3() %>%
          ...
          select(
            "År", "Medelvärde antal honor", "Undre konfidensintervall",
